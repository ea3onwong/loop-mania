...
public class zombiePitCardTest {
    ...
    public void zombiePitTest() {
        ...
        //Load one zombie pit card and check again the entity for both, now card entity should be 1 and building entity should be 0
        ...
        world.convertZombiePitCardToBuildingByCoordinates(0,0,1,1);
        assertEquals(world.getCardEntities().size(), 0);
