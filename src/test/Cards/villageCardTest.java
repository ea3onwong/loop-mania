...
public class villageCardTest {
    ...
    public void villageTest() {
        ...
        //Load one village card and check again the entity for both, now card entity should be 1 and building entity should be 0
        ...
        world.convertVillageCardToBuildingByCoordinates(0,0,0,0);
        assertEquals(world.getCardEntities().size(), 0);
