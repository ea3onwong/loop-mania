...
public class alchemistTentCardTest {
    @Test
    public void alchemistTentTest() {
        ...
        //Load one alchemistTent card and check again the entity for both, now card entity should be 1 and building entity should be 0
        world.loadAlchemistTentCard();
        ...
        world.convertAlchemistTentCardToBuildingByCoordinates(0,0,0,0);
        assertEquals(world.getCardEntities().size(), 0);
