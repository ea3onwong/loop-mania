...
public class fieldKitchenCardTest {
    @Test
    public void fieldKitchenTest() {
        ...
        //Load one Field Kitchen card and check again the entity for both, now card entity should be 1 and building entity should be 0
        world.loadFieldKitchenCard();
        ...
        world.convertFieldKitchenCardToBuildingByCoordinates(0,0,0,0);
        assertEquals(world.getCardEntities().size(), 0);
