...
public class survivorsTentsCardTest {
    @Test
    public void survivorsTentsTest() {
        ...
        //Load one survivorsTents card and check again the entity for both, now card entity should be 1 and building entity should be 0
        world.loadSurvivorsTentsCard();
        ...
        world.convertSurvivorsTentsCardToBuildingByCoordinates(0,0,0,0);
        assertEquals(world.getCardEntities().size(), 0);
