...
public class holySpringCardTest {
    @Test
    public void holySpringTest() {
        ...
        //Load one Holy Spring card and check again the entity for both, now card entity should be 1 and building entity should be 0
        world.loadHolySpringCard();
        ...
        world.convertHolySpringCardToBuildingByCoordinates(0,0,0,0);
        assertEquals(world.getCardEntities().size(), 0);
