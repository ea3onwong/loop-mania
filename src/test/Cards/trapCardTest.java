...
public class trapCardTest {
    ...
    public void trapTest() {
        ...
        //Load one trap card and check again the entity for both, now card entity should be 1 and building entity should be 0
        world.loadTrapCard();
        ...
        world.convertTrapCardToBuildingByCoordinates(0,0,0,0);
        assertEquals(world.getCardEntities().size(), 0);
