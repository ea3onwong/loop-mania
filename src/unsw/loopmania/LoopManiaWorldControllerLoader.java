...
public class LoopManiaWorldControllerLoader extends LoopManiaWorldLoader {
    ...
    @Override
    public void onLoad(HeroCastleBuilding heroCastleBuilding) {
        ImageView view = new ImageView(heroCastleImage);
        addEntity(heroCastleBuilding, view);
    }
    @Override
    public void onLoad(ZombiePitBuilding pit) {
        ImageView view = new ImageView(zombiePitImage);
        addEntity(pit, view);
    }
    @Override
    public void onLoad(VampireCastleBuilding castle) {
        ImageView view = new ImageView(vampireCastleImage);
        addEntity(castle, view);
    }
    @Override
    public void onLoad(TowerBuilding tower) {
        ImageView view = new ImageView(towerImage);
        addEntity(tower, view);
    }
    @Override
    public void onLoad(BarracksBuilding barracks) {
        ImageView view = new ImageView(barracksImage);
        addEntity(barracks, view);
    }
    @Override
    public void onLoad(CampfireBuilding campfire) {
        ImageView view = new ImageView(campfireImage);
        addEntity(campfire, view);
    }
    @Override
    public void onLoad(VillageBuilding village) {
