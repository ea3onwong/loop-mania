...
/**
 * represents a Field Kitchen Card in the backend game world
 */
public class FieldKitchenCard extends Card {
    
    private CardLootTable lootTable;
    private final int EXP = 30;
    private final int GOLD = 30;

    public FieldKitchenCard(SimpleIntegerProperty x, SimpleIntegerProperty y) {
        super(x, y);
